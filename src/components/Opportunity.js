                    ...
                    <div className="jos-details-container">
                      <div className="jos-banner-content">
                        <h1 className="heading">
                          Helping Businessess in all domains
                        </h1>
                        <p className="subheading">
                          Succesfully delivered digital products and platform
                          for a diverse range of use cases across key
                          industries.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="jos-banner-container job-specialization-digital-marketing">
                    <div className="jos-details-container">
                      <div className="jos-banner-content">
                        ...
                        <p className="subheading">
                          Our business is tech. We stay ahead of the disruption
                          curve, so you can focus on what matters human
                          experience.
                        </p>
                      </div>
                    </div>
                ...
                <div className="carousel-item">
                  <div className="jos-banner-container job-specialization-data-science">
                    <div className="jos-details-container">
                      <div className="jos-banner-content">
                        <h1 className="heading">
                          Go live in days and weeks, not in months and years
                        </h1>
                        <p className="subheading">
                          we have created 100+ developer support case that that
                          have saved our customers 1000+ hours in consulting
                          fees.
                        </p>
                      </div>
                    </div>
